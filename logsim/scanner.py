...
class Scanner:
    ...
    def __init__(self, path, names):
        ...
        '''
        self.keywords_list = ["Device", "Connection", "Monitor", "is", "are", "input", 
        "simulation", "connect"] #keyword that cannot be ignored
        [self.DEVICES_ID, self.CONNECTION_ID, self.MONITOR_ID, self.IS_ID, self.ARE_ID,
    ...
    def get_symbol(self):
        ...
        if self.current_character.isalpha(): # name
            ...
            name_string = name_string_list[0]
